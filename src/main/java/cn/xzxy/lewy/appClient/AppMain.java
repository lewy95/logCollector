package cn.xzxy.lewy.appClient;
...
public class AppMain {
    ...
    private static void generateLog(Long delay, int loop_len) {
        ...
        for (int i = 0; i < loop_len; i++) {
            ...
            switch (flag) {
                case (0):
                    //应用启动
                    AppStartLog appStart = generateStart();
    ...
    private static JSONObject generateComFields() {
        ...
        AppBaseLog appBase = new AppBaseLog();
    ...
    private static JSONObject generateDisplay() {
        ...
        AppDisplayLog appDisplay = new AppDisplayLog();
    ...
    private static JSONObject generateNewsDetail() {
        ...
        AppNewsDetailLog appNewsDetail = new AppNewsDetailLog();
    ...
    private static JSONObject generateNewList() {
        ...
        AppLoadingLog appLoading = new AppLoadingLog();
     ...
     * 启动日志
     */
    private static AppStartLog generateStart() {

        AppStartLog appStart = new AppStartLog();
    ...
    private static JSONObject generateNotification() {
        ...
        AppNotificationLog appNotification = new AppNotificationLog();
    ...
    private static JSONObject generatbeforeground() {
        ...
        AppActiveForeLog appActive_foreground = new AppActiveForeLog();
    ...
    private static JSONObject generateBackground() {
        ...
        AppActiveBackLog appActive_background = new AppActiveBackLog();
    ...
    private static JSONObject generateFavorites() {
        ...
        AppFavoritesLog favorites = new AppFavoritesLog();
    ...
    private static JSONObject generatePraise() {
        ...
        AppPraiseLog praise = new AppPraiseLog();
    ...
    private static JSONObject generateComment() {
        ...
        AppCommentLog comment = new AppCommentLog();
